jQuery(function($) {
    ...
    $("#ctNum").select2({
        ...
        , placeholder: ''
        , ajax: {
            url: 'indexServeur.php?TypeFac=0&page='+select2Url,
            dataType: "json",
            type: "GET",
    ...
    function lettrageEcriture(annuler){
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data[0].Result==0) {
                    $("#alertInfo").hide()
                    $("#alertInfo").html("Le solde lettrage n'est pas egale à zéro !")
                    ...
                    $("#alertInfo").hide()
                    $("#alertInfo").html("Le montant d'une écriture est déjà lettré !")
                    $("#alertInfo").removeClass("alert-danger")
                    $("#alertInfo").removeClass("alert-success")
                    $("#alertInfo").addClass("alert-danger")
                    $("#alertInfo").show("slow")
                    ...
                    getLettrage()
                    $("#alertInfo").hide()
                    var info = "Le montant d'une écriture a été lettré !"
                    if(annuler == 0)
                        info = "Le montant d'une écriture a été annulé !"
                    $("#alertInfo").html(info)
                    $("#alertInfo").removeClass("alert-danger")
                    $("#alertInfo").removeClass("alert-success")
