...
<?php if($type=="Ticket" || (($type=="Vente" || $type=="VenteC" || $type=="VenteT") && $flagModifClient!=0) || $readonly
    ...
    <div class="col-sm-4">
        <label>Cat tarif : </label>
                <select class="form-control"
                    ...
                    <?php if($protection->PROT_TARIFICATION_CLIENT!=0 || $isVisu) echo "readonly"; ?>>
                    <?php
    ...
    <div class="col-sm-4">
        ...
        <select type="input" name="cat_compta" id="cat_compta" class="form-control" style="<?= $styleTicket ?>" <?php if((isset($_GET["cbMarq"]) && $isLigne==1) || $isVisu) echo "readonly"; ?>>
        <?php
    ...
    <div class="form-group">
        <div class="col-sm-4">
            <label>Souche : </label>
            <select class="form-control" id="souche" name="souche" style="<?= $styleTicket ?>" <?php if(isset($_GET["cbMarq"]) || $isVisu) echo "readonly"; ?>>
                <?php
        ...
        <div class="col-sm-4">
            <label>Affaire : </label>
            <select class="form-control" id="affaire" name="affaire" style="<?= $styleTicket ?>" <?php if($isVisu || $readonly || (isset($_GET["cbMarq"]))) echo "readonly"; ?>>
                <php
                        if($admin!=0){
                    echo "<option value=''></option>";
                }
    ...
    <div class="form-group">
        ...
        <label>Depot : </label>
            <select class="form-control" name="depot" id="depot" style="<?= $styleTicket ?>" <?php
                                    if($isVisu || $readonly || (isset($_GET["cbMarq"]))) echo "readonly"; ?>>
                    <?php
                    $isPrincipal = 0;
                    if($admin==0){
                        $isPrincipal = 1;
        ...
        <div class="col-sm-4">
            ...
            <select class="form-control" name="collaborateur" id="collaborateur" style="<?= $styleTicket ?>" <?php if($readonly || $isVisu) echo "readonly"; ?>>
        ...
        <div class="col-sm-4">
            <label>Caisse : </label>
            <select class="form-control" name="caisse" id="caisse" style="<?= $styleTicket ?>" <?php if($readonly || isset($_GET["cbMarq"]) || $isVisu) echo "readonly"; ?>>
                    <?php
                    $isPrincipal = 0;
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <label>Statut : </label>
                <select class="form-control" name="do_statut" id="do_statut" style="<?= $styleTicket ?>" <?php if($readonly || $isVisu) echo "readonly"; ?>>
                    <?php
