        ...
        if($rows==null){
            ...
            if($i%2==0)
                ...
                echo "<tr class='facture $classe' id='article_".$row->cbMarq."'";
                    echo "><td id='AR_Ref'>".$row->AR_Ref."</td>"
                    . "<td id='DL_Design'>".$row->DL_Design."</td>"
                    . "<td id='DL_PrixUnitaire'>"; /*if($prixRevient>1) */echo round($row->DL_PrixUnitaire,2); echo"</td>"
                    . "<td id='DL_Qte'>".(round($row->DL_Qte*100)/100)."</td>"
                    . "<td id='DL_MontantHT'>"; /*if($prixRevient>1) */echo $montantHT; echo"</td>"
                    ...
                    if($type=="Transfert_detail")
                        echo "<td id='AR_Ref_dest'>".$row->AR_Ref_Dest."</td>
                             <td id='AR_Design_dest'>".$row->DL_Design_Dest."</td>
                                ...
                                <td id='DL_MontantHT_dest'>"; /*if($prixRevient>1) */echo $montantHT_dest; echo"</td>";
