            ...
            foreach ($rows as $row){
                ...
                echo "<tr style='padding:10px'>"
                    ...
                    if($profil_gestionnaire==0)
                        echo  "<td style='padding:3px;text-align:right$bordure'>".$objet->formatChiffre(round($row->DL_PrixUnitaire_Rem0,2))."</td>"
                    . "<td style='padding:3px;text-align:right$bordure'>".$objet->formatChiffre(ROUND($row->DL_MontantHT,2))."</td></tr>";
            }
        }
        ?>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 0px">Montant total HT :</td><td style="border-left : 1px;border-bottom: 0px;text-align: right"><?php echo $objet->formatChiffre($totalMontantHT); ?></td></tr>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 0px">Remise :</td><td style="border-left : 1px;border-bottom: 0px;text-align: right"><?php echo $objet->formatChiffre("0"); ?></td></tr>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 0px">Net commercial :</td><td style="border-left : 1px;border-bottom: 0px;text-align: right"><?php echo $objet->formatChiffre($totalMontantHT); ?></td></tr>
        <?php if($libelle1!=null || $libelle1 != "") { ?>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 0px"><?php echo $libelle1; ?>:</td><td style="border-left : 1px;border-bottom: 0px;text-align: right"><?php echo $objet->formatChiffre($totalTaxe1); ?></td></tr>
        <?php } ?>
        <?php if($libelle2!=null || $libelle2 != "") { ?>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 0px"><?php echo $libelle2; ?>:</td><td style="border-left : 1px;border-bottom: 0px;text-align: right"><?php echo $objet->formatChiffre($totalTaxe2); ?></td></tr>
        <?php } ?>
        <?php if($libelle3!=null || $libelle3 != "") { ?>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 0px"><?php echo $libelle3; ?>:</td><td style="border-left : 1px;border-bottom: 0px;text-align: right"><?php echo $objet->formatChiffre($totalTaxe3); ?></td></tr>
        <?php } ?>
        <tr><td colspan="2" style="border-top: 1px;border-left: 0px"></td><td colspan="2" style="border-left : 1px;border-bottom: 1px">Net à payer :</td><td style="border-left : 1px;border-bottom: 1px;text-align: right"><?php echo $objet->formatChiffre($totalMontantTTC); ?></td></tr>
    </tbody></table>
<br/>
<br/>
<?php }
        ...
        if($rows==null){
            ...
            foreach ($rows as $row){
                ...
                echo "<tr style='padding:10px$bordure'>"
                    ...
                    . "<td style='padding:3px;text-align:center$bordure'>".round($row->DL_Qte)."</td>";
                if($profil_gestionnaire==0)
                    echo "<td style='padding:3px;;text-align:right$bordure'>".$objet->formatChiffre(round($row->DL_PUTTC_Rem0,2))."</td>"
