...
$datedeb = $_GET["dateReglementEntete_deb"];
$datefin = $_GET["dateReglementEntete_fin"];
...
<div><?php echo $nomSociete."<br>".$profession."<br>".$ville; ?></div>
<div style="text-align: center"> <?php echo "<b>".$libtype."</b>"; ?> </div>
    ...
    <div>Date de l'opération :</div>
<div style="text-align:center"><b><?php echo "Mouvement de caisse"; ?> </b></div>
<br/>
<table id="table" class="facture" style="border:1px solid black;">
    ...
    <?php
        ...
        $result=$objet->db->requete($objet->listeReglementCaisse($datedeb,$datefin,$ca_no,$type));     
        $rows = $result->fetchAll(PDO::FETCH_OBJ);
        $i=0;
        $classe="";
        $sommeMnt = 0;
        if($rows==null){
            ...
            foreach ($rows as $row){
                ...
                echo "<tr style='padding:10px'>"
                    ...
                    . "<td style='padding:3px;text-align:right'>".$objet->formatChiffre(ROUND($montant,2))."</td>"
