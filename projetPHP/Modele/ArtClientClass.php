...
class ArtClientClass Extends Objet{
    ...
    public function insertIntoFArtClient(){
        $query= "INSERT INTO [dbo].[F_ARTCLIENT]
                  ...
                  VALUES
                        (/*AR_Ref, varchar(19),*/'{$this->AR_Ref}',/*AC_Categorie*/{$this->AC_Categorie},/*AC_PrixVen*/0,/*AC_Coef*/0
                        ,/*AC_PrixTTC*/{$this->AC_PrixTTC},/*AC_Arrondi*/0,/*AC_QteMont*/0,/*EG_Champ*/0
