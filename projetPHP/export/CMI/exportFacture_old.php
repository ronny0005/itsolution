            ...
            <table id="Tableentete">
                <tr style="font-size: 12px">
                    ...
                    <td style="width:200px">
                        <img  style="width:86px; height:85px;" alt="logo CM" src="../../images/LOGO%20CMI.png" />
                    </td>
                    <td>
...
$ct_identifiant."<br/>";
    ...
    <?php echo "<b>$nomdepot - $complementDepot</b>"; ?>
                ...
                <div style='<?php if($hideDivers==2) echo "text-align: right;margin-left: 50px;";?>'><?php echo "<span style='text-decoration:underline'><b>Collaborateur :</b></span> $collaborateur &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"; ?></div>
