...
<form action="indexMVC.php?action=3&module=2" method="GET" name="form-ligne" id="form-ligne">
    ...
    <div class="<?php echo $classQte; ?> col-xs-3 col-sm-3 col-md-2 col-lg-1" >
    ...
    <div class="col-xs-6 col-sm-5 col-md-4 col-lg-2" style="<?php if((($type=="Achat" || $type=="AchatC" || $type=="AchatT" ||
...
<div class="form-row">
    <table id="tableLigne" class="table table-striped table-responsive" style="martgin-top : 10px">
    <thead>
        <tr>
            <th>Référence</th>
            <th>Désignation</th>
