...
<div id="milieu">
    <div class="container">
        ...
        <form action="<?= $lienForm; ?>" method="GET">
            ...
            <div class="mt-0 col-xs-0 col-sm-0 col-md-0 col-lg-7" >
            </div>
            <div class="mt-2 col-xs-6 col-sm-8 col-md-10 col-lg-10" >
                <label>&nbsp;</label>
                <input type="button" id="imprimer" class="btn btn-primary" value="Imprimer"/>
            </div>
            <div class="mt-2 col-xs-6 col-sm-4 col-md-2 col-lg-2 text-right" >
        ...
        <fieldset class="entete">
            <form id="formValider" action="Traitement/Recouvrement.php" method="GET" class="form-horizontal">
                ...
                <?php if($flagProtected) { ?>
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-12 col-lg-2 mb-2">
            ...
            <div class="form-group">
                <div id="blocListeReglement" style="float:left;width:540px;clear: both;height: 300px;overflow: scroll;">
                    <table class="table table-striped" id="tableRecouvrement" style="width:500px">
                        <thead>
                        <tr>
                            <?= ($flagProtected) ? "<th></th>" : "" ?>
                            <?= ($flagSuppr) ? "<th></th>" : "" ?>
