...
<div class="container clearfix">
    <h4 id="logo" style="text-align: center;background-color: #eee;padding: 10px;text-transform: uppercase">Mise à jour Analytique
    </h4>
</div>
<div class="corps">        
...
<form id="form-entete" class="form-horizontal" action="indexMVC.php?module=9&action=17" method="POST" >
