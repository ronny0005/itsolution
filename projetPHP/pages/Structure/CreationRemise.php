...
<div class="form-group col-lg-4" >
    <input type="button" id="ajouterRemise" name="ajouterRemise" class="btn btn-primary" value="Valider" <?php if(!$flagProtected) echo "disabled"; ?>/>
</div>        
