...
<li class="<?php if($_GET["module"]==9 && ($_GET["action"]==19) && ($_GET["type"]=="Tiers")) echo "active"; ?>"><a href="indexMVC.php?module=9&action=19&type=Tiers">Interrogation tiers</a></li>
<li class="<?php if($_GET["module"]==9 && ($_GET["action"]==19) && ($_GET["type"]=="Lettrage")) echo "active"; ?>"><a href="indexMVC.php?module=9&action=19&type=Lettrage">Interrogation et lettrage</a></li>
...
<li class="<?php if($_GET["module"]==9 && ($_GET["action"]==17)) echo "active"; ?>"><a href="indexMVC.php?module=9&action=17">Mise à jour Analytique</a></li>
    <?php
    if(($protection->PROT_Right==1 || ($protection->PROT_CLOTURE_CAISSE!=2))) {
        ?>
        <li class="<?php if ($_GET["module"] == 9 && ($_GET["action"] == 18)) echo "active"; ?>">
            <a href="indexMVC.php?module=9&action=18">Clotûre de caisse</a>
        </li>
        <?php
    }
        ?>