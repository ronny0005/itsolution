...
if($protection->Prot_No!=""){
    ...
    <?php }
    if($objet->db->flagDataOr ==1 && ($protection->PROT_Right==1 || ($protection->PROT_DOCUMENT_VENTE!=2))){
        ?>
        <li class="<?php if($_GET["module"]==2 && ($_GET["action"]==11||$_GET["action"]==12)) echo "active"; ?>"><a href="indexMVC.php?module=2&action=11&type=VenteDevise">Vente devise</a></li>
    <?php }
