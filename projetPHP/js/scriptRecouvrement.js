...
//                    if(this.PROT_DOCUMENT_REGLEMENT==1)
    ...
    $('#imprimer').click(function(){
        var impression="export/exportReglementZumi.php?CT_Num="+$("#CT_Num").val()+"&datedeb="+returnDate($("#dateReglementEntete_deb").val())+"&datefin="+returnDate($("#dateReglementEntete_fin").val())+"&type="+$("#type").val()+"&mode_reglement="+$("#mode_reglement").val()+"&caisse="+$("#caisse").val()+"&typeRegl="+$_GET("typeRegl");
...
//            $("#tableFacture").append("</table>");
    ...
    function tableauRecouvrement(classe,RG_No,RG_Date,RG_Libelle,RG_Montant,RC_Montant,CA_No,CO_NoCaissier,RG_Impute,RG_Piece,N_Reglement,CO_No,JO_Num,DO_Modif){
        ...
        $("#tableRecouvrement").append("<tr class= 'reglement " + classe + "' id='reglement_" + RG_No + "'>"+texteProtected+texteSuppr+"<td id='RG_Piece' style='color:blue;text-decoration: underline;'>"+RG_Piece+"</td><td id='RG_Date'>" + $.datepicker.formatDate('yy-mm-dd', new Date(RG_Date)) + "</td>\n\
                                        <td id='RG_Libelle'>" + RG_Libelle + "</td><td id='RG_Montant'>" + (RG_Montant) + "</td><td id='RC_Montant'>" + (RC_Montant) + "</td><td id='RA_Montant'>" + ((RG_Montant-RC_Montant)) + "</td>\n\
                    ...
                    buttons: {
                        ...
                        "Voir facture réglée": {
                            ...
                            click: function () {
                                ...
                                <td>" + this.DO_Ref + "</td><td id='avanceRGNO'>" + (this.avance) + "</td><td id='ttcRGNO'>" + (this.ttc) + "</td>" + texteSuppr + "<td id='cbMarqEntete' style='visibility:hidden'>" + this.cbMarq + "</td></tr>");
                                        });
