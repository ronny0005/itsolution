jQuery(function($) {
    ...
    function setArticle() {
        ...
        $("#reference_dest").autocomplete({
            source: "indexServeur.php?page=getArticleByRefDesignationMvtTransfert&type=" + $_GET("type") + "&DE_No=" + $("#CO_No").val(),
            autoFocus: true,
            select: function (event, ui) {
                event.preventDefault();
    ...
    //if(isModif==1 && $_GET("cbMarq")!=undefined)
        setArticle()
...
//                        $("#quantite_stock").val(Math.round(this.AS_QteSto * 100) / 100);
        ...
        function fichierTraitement() {
            ...
            if (fich == "Transfert" || fich == "Transfert_confirmation" || fich == "Transfert_valid_confirmation" ) {
                ...
                if ($_GET("cbMarq") != null)
                    impressionMouvement = "etatspdf/MvtTransfertpdf.php?cbMarq="+$_GET("cbMarq")+"&type=" + fich;
                else
                    impressionMouvement = "etatspdf/MvtTransfertpdf.php?cbMarq="+$_GET("cbMarq")+"&type=" + fich;
            ...
            if (fich == "Entree") {
                ...
                if ($_GET("cbMarq") != null)
                    impressionMouvement = "etatspdf/MvtEntreepdf.php?cbMarq="+$_GET("cbMarq")+"&type=" + fich;
                else
                    impressionMouvement = "etatspdf/MvtEntreepdf.php?cbMarq="+$_GET("cbMarq")+"&type=" + fich;
                return "Entree.php";
            }
            if (fich == "Sortie") {
                ...
                if ($_GET("cbMarq") != null)
                    impressionMouvement = "etatspdf/MvtSortiepdf.php?cbMarq="+$_GET("cbMarq")+"&type=" + fich;
                else
                    impressionMouvement = "etatspdf/MvtSortiepdf.php?cbMarq="+$_GET("cbMarq")+"&type=" + fich;
                return "Sortie.php";
            }
...
//            if($_GET("type")=="Transfert" || $_GET("type")=="Transfert_confirmation")
    ...
    function valideEntete(){
        var affaire = "";
        if($("#cbMarqEntete").val()=="")
        if(($_GET("type")!="Transfert" && $_GET("type")!="Transfert_confirmation" && $_GET("type")!="Transfert_detail" && $("#DE_No").val()!="") ||
                (($_GET("type")=="Transfert" || $_GET("type")=="Transfert_confirmation" || $_GET("type")=="Transfert_detail") && $("#DE_No").val()!="" && $("#CO_No").val()!="" && $("#DE_No").val()!=$("#CO_No").val())){
            if($("#affaire").val()!="null")
                affaire = $("#affaire").val();
            $.ajax({
