    ...
    function ajouterClient(){
        if($_GET("CA_No")==null){
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(data) {
                    window.location.replace("indexMVC.php?module=3&action=10&acte=ajoutOK&DE_No="+data.CA_No);
                } 
            }); 
        }else {
            var num ='';
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function(data) {
                    window.location.replace("indexMVC.php?module=3&action=10&acte=modifOK&DE_No="+data.CA_No);
                } 
            });
        }
    }
